...
export default function Home() {
  ...
  useSEO({
    title: "Авторские туры по Швейцарии с русскоязычным гидом — Sweasy",
    description:
      "Индивидуальные туры по Швейцарии с частным русскоязычным гидом. Альпы, Цюрих, Люцерн, Интерлакен, хайкинг, яхтинг на Женевском озере — настоящая Швейцария для тебя.",
  });
